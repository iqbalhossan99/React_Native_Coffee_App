...
const BottomTabNavigation = () => {
  return (
    <Tab.Navigator 
    screenOptions={{
      tabBarStyle: { backgroundColor:"#0B0B0B",  height:80, width:'100%', borderTopLeftRadius:30, borderTopRightRadius:30, marginTop:-30, paddingLeft:44, paddingRight:44, paddingTop:13,  }, 
